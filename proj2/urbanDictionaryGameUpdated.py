...
# Get the best definition from the choice with more thumbs up
bestDef = ""
if oneGuesses >= twoGuesses:
    bestDef = randomOptions[0]['definition']
else:
    bestDef = randomOptions[1]['definition']

# Remove the brackets from best def
fixedDef = ""
for char in bestDef:
    if not (char == '[' or char == ']'):
        fixedDef = fixedDef + char
...
print("The better definition of \"" + search + "\" was: " + bestDef)